...
{% if site.data.fellowship %}
<div class="section-card">
<h4>Fellowship</h4>
<div class="sponsor-logos" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: var(--space-6);">
{% for fellowship in site.data.fellowship %}
<a href="{{ fellowship.url }}" target="_blank"><img src="{{ site.url }}{{ site.baseurl }}/images/{{ fellowship.image }}" alt="fellowship logo" style="max-height: 80px; max-width: 200px; border-radius: 0;" loading="lazy"></a>
{% endfor %}
</div>
</div>
{% endif %}
